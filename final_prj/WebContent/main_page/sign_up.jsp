...
<style type="text/css">
	...
	/* 헤더시작 */
	#header{width: 500px; min-height: 80px; border: 1px solid red; margin-left: auto; margin-right: auto; padding-top: 50px; padding-bottom: 50px }
	#hContent{width: 370px; margin-left: auto; margin-right: auto; border:  1px solid blue;}
	...
	/* 헤더끝 */
	/* 컨테이너 시작 */
	#containerSignup{min-height: 900px; width: 700px; border: 1px solid red; margin-left: auto; margin-right: auto;}
	.divider-text {
    position: relative;
    text-align: center;
    margin-top: 15px;
...
<div id="header">
	<div id="hContent" >
	  <a id="hTitle" class="navbar-brand" href="#" >
	    <img id="hLogo" src="http://localhost:8080/ui_prj3/main_page/images/logo.png" class="d-inline-block align-center" alt="" >
	    Yul's Coffee  
	  </a>
	</div>   
</div>
